...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const rateLimitScope = `smarttheater-api:${String((_a = req.project) === null || _a === void 0 ? void 0 : _a.id)}:rateLimit:${routeIdentifier}:${req.method}`;
        yield middlewares.rateLimit({
            ...
            limitExceededHandler: (_, __, resOnLimitExceeded, nextOnLimitExceeded) => {
                ...
                nextOnLimitExceeded(new cinerinoapi.factory.errors.RateLimitExceeded(message));
            },
            // スコープ生成ロジックをカスタマイズ
