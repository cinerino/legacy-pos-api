...
// 集計データーつきのパフォーマンス検索
previewRouter.get('/projects/:projectId/performancesWithAggregation', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const conditions = {
...
// 入場場所検索
previewRouter.get('/projects/:projectId/places/checkinGate', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // chevreで取得
